                ...
                items.map((p) => (
                  <TableRow key={p.id}>
                    ...
                    <TableCell className="px-5 py-4 text-right text-theme-sm">
                      {puede("marcas.editar") && <button onClick={() => abrirEditar(p)} className="mr-3 text-brand-500 hover:underline">Editar</button>}
                      {puede("marcas.eliminar") && <button onClick={() => borrar(p)} className="text-error-500 hover:underline">Eliminar</button>}
                    </TableCell>
                  </TableRow>
                ))
              )}
