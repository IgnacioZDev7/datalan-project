...
export default function UserDropdown() {
  ...
  const iniciales = (usuario?.nombres ?? "U").charAt(0).toUpperCase();
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 text-sm font-semibold text-white rounded-full h-11 w-11 bg-brand-500">
          {iniciales}
        </span>
        <span className="block mr-1 font-medium text-theme-sm">{usuario?.nombres ?? "Usuario"}</span>
        <svg
      ...
      >
        ...
        >
          <svg className="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M12 3.75a3.75 3.75 0 00-3.75 3.75V9.5A2.5 2.5 0 006 12v6a2.5 2.5 0 002.5 2.5h7A2.5 2.5 0 0018 18v-6a2.5 2.5 0 00-2.25-2.489V7.5A3.75 3.75 0 0012 3.75zm2.25 5.626V7.5a2.25 2.25 0 10-4.5 0v1.876h4.5z" />
          </svg>
          Cambiar contraseña
        </Link>
        ...
        <button
          ...
          className="flex items-center w-full gap-3 px-3 py-2 mt-1 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg className="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
